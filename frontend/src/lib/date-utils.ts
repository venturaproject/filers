...
export function safeParseDate(date: DateLike | null | undefined): Date | undefined {
...
export function safeParseTime(time: string | null | undefined): ReturnType<typeof parseTime> | "" {
  try {
...
/** @deprecated */
export function emailDateFormat(time: DateLike | null | undefined): string {
  if (time) {
