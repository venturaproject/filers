...
/**
 * A minimal "run one file through the API and see the result" helper — handy
 * for sanity-checking the processing service. The real work happens through the
 * API; this admin is otherwise for monitoring (see Procesamientos / Dashboard).
 */
        ...
        <div className="grid max-w-5xl flex-1 items-start gap-6 md:gap-8">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Prueba rápida del servicio: sube un Excel o CSV y comprueba el JSON que devuelve la
              API. Toda la actividad real queda registrada en{' '}
